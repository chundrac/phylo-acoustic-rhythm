...
dir.create('output_birdsandmammals')
...
bird.and.mammal.orders <- c(mammal.orders,bird.orders)

data.df <- data.df[data.df$Order %in% bird.and.mammal.orders,]
...
saveRDS(fit,file=paste('output_birdsandmammals/',mod.type,'_',my.seed,'.RDS',sep=''))