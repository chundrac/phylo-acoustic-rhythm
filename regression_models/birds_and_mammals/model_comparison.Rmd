...
The distributional model without predictors included has the highest ELPD value, but it is not substantially higher than the full distributional model (e.g., more than 2 std. errors higher). This is the mirror image of the results for all taxa.
...
In terms of stacking weight, we see that the distributional model without predictors has the majority of the stacking weight, but the full distributional model still has a substantial amount of stacking weight. 
